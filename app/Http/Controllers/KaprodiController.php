...
class KaprodiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kaprodi', compact('kaprodi','users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $message = 'User Kaprodi berhasil dtambahkan!';
            
            return redirect('/kaprodi')->with('success', $message);

        } catch (\Exception $e) {
            DB::rollBack();
            // Log error untuk debug
            
            return redirect()->back()->withInput()->with('error', 'Terjadi kesalahan saat menyimpan data Kaprodi. ' . $e->getMessage());
        }
        return redirect('/kaprodi')->with('success', 'Kaprodi berhasil ditambahkan!');
    }
    ...
    public function update(Request $request,  $id)
    {
        ...
        return redirect('/kaprodi')->with('success', 'Kaprodi berhasil diperbarui!');
    }
    ...
    public function destroy( $id)
    {
        ...
        return redirect('/kaprodi')->with('success', 'Kaprodi berhasil dihapus!');
    }
}
