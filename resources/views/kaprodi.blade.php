                                    ...
                                    @if (auth()->user()->dekan)
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-outline-primary btn-sm btn-edit"
                                                ...
                                                data-username="{{ $kls->user->username }}"
                                                ...
                                                data-alamat="{{ $kls->user->Biodata->alamat }}"> <i
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="dekanFormModalLabel">Tambah data Kaprodi</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form method="POST" action="/kaprodi" method="POST">
                    @csrf
                    @method('POST')
                    <div class="modal-body">
                        ...
                        <div id="new-user-block" class="d-none">
                            <h5 class="mt-4 mb-3 text-primary">Data Kaprodi Baru</h5>
                            <div class="mb-3">
    ...
    <div class="modal fade" id="editRoleModal" tabindex="-1" aria-labelledby="editRoleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form class="modal-content" id="editRoleForm" action="" method="POST">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="editRoleModalLabel">Edit Kaprodi: <span id="edit-role-name"></span></h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="edit-nama" class="form-label">Nama Kaprodi</label>
    ...
    <div class="modal fade" id="deleteRoleModal" tabindex="-1" aria-labelledby="deleteRoleModalLabel"
        ...
        <div class="modal-dialog modal-sm">
            ...
            <form class="modal-content" id="deleteRoleForm" action="" method="POST">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus Kaprodi ini? **<span id="delete-role-name"></span>**?</p>
                    <input type="hidden" name="id" id="delete-id">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-danger">Ya, Hapus Kaprodi Ini</button>
                </div>
            </form>
        </div>
    </div>
