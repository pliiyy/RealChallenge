                    ...
                    <div class="col-md-6 bg-white p-5">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control" required autofocus placeholder="nama@email.com" value="{{ old('email') }}">
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="#" class="small-link text-decoration-none text-primary">Lupa password?</a>
                            </div>
                        ...
                        <div class="text-center mt-4 small-link">
                            Belum punya akun?
                            <a href="#" class="text-primary text-decoration-none fw-semibold">Daftar sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
